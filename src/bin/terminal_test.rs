...
fn main() -> crossterm::Result<()> {
    ...
    with_terminal(|terminal| {
        ...
        // Draw a title
        terminal.draw_text_centered(center_y - 4, "Terminal Test", Color::Yellow, Color::Black)?;
        ...
        terminal.draw_text_centered(2, "Color Test", Color::White, Color::Black)?;
        ...
        for (i, (color, name)) in colors.iter().enumerate() {
            terminal.draw_text(5, 4 + i as u16, name, *color, Color::Black)?;
        }
