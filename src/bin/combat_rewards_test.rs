...
use ascii_dungeon_explorer::systems::{
    CombatRewardsSystem, TreasureGenerationSystem, TreasureSystem,
};
...
fn main() {
    ...
    let boss_monster = world
        ...
        .with(BossEnemy {
            ...
            guaranteed_drops: vec![LootDrop::Equipment {
    ...
    let treasure_loot_table = TreasureGenerationSystem::create_standard_loot_table(
        5,
